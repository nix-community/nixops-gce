...
from nixops-gcp.resources.gce_http_health_check import GCEHTTPHealthCheckState
from nixops.util import attr_property
from nixops-gcp.gcp_common import ResourceDefinition, ResourceState, optional_string
